...
def main() -> None:
    ...
    started = time.time()
    # checkpoint_path=OUTPUT_PATH: neu tien trinh bi ngat giua chung (da tung
    # gap khi chay thuc te), lan chay lai doc duoc phan da crawl va chi crawl
    # tiep phan con thieu thay vi lam lai tu dau.
